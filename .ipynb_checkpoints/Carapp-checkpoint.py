...
owner = st.selectbox('Owner type', cars_data['owner'].unique()) # Fixed the duplicate "Seller type" label here
...
if st.button("Predict"):
    ...
    st.markdown(f'### Car Price is going to be ₹ {round(car_price[0], 2):,}')
